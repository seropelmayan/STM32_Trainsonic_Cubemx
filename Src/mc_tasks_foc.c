...
volatile float    g_spdcap_hard_rpm  = 650.0f; /* ABSOLUTE firmware ceiling: the governor always enforces
                                                  ...
                                                  heartbeat asks for 800; it is clamped to this. 650
                                                  (Serop, 2026-09-08): the "old method" -- plain
                                                  governor roll-off (530..650) + brake above, no
                                                  command fading of any kind -- was preferred over the
                                                  modulation-ceiling / low-pack-taper experiments,
                                                  which are reverted. Only affects MOTOR-driven motion
